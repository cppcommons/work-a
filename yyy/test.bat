...
::implib /system sqlite3-dm32.lib sqlite3.dll
implib /system sqlite-win32-x86-3200100-dm32.lib sqlite-win32-x86-3200100.dll
setlocal
...
if not exist sqlite-win32-x86-3200100-ms32.lib (
  lib /def:sqlite-win32-x86-3200100.def /machine:x86 /out:sqlite-win32-x86-3200100-ms32.lib
 )
endlocal
if %errorlevel% neq 0 (
